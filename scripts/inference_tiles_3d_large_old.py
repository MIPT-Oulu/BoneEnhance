...
if __name__ == "__main__":
    ...
    snap_path = '../../Workdir/ankle_experiments'
    ...
    for snap_id in range(len(snaps)):
        ...
        parser.add_argument('--snapshot', type=Path, default=os.path.join(snap_path, snap))
        ...
        for idx, sample in enumerate(samples):
            print(f'==> Processing sample {idx + 1} of {len(samples)}: {sample}, snap {snap}')
