...
from bone_enhance.transforms.custom_transforms import Crop, Pad, Brightness, Contrast, Blur, Flip, Rotate90, rand_gamma, \
    Noise
    ...
    # 2D super-resolution
        ...
        transforms = slc.SelectiveStream([
            slc.Stream([
                ...
                # 50% Chance for gamma
                slc.Stream([rand_gamma(gamma=tuple(trf.get('gamma', 0.2)), p=trf.get('p_gamma', 0.5))]),
